...
/**
 * A pass-through wrapper for {@link Connection}.
 * Adds no additional functionality.
 * It is expected that derived classes override some of the methods.
 */
public abstract class BasicConnectionWrapper implements Connection {
     ...
     */
    protected BasicConnectionWrapper(Connection wrapped){
